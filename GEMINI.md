...
## Animations
- **Library**: ALWAYS use `framer-motion` for animations.
- **Avoid**: Do not use standard CSS transitions or keyframes for complex animations unless absolutely necessary for performance.
