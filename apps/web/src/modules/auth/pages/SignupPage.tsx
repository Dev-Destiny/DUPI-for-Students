...
const SignupPage: FC = () => {
	...
	const strength = useMemo(() => {
		...
		if (metCount < 3)
			return { label: "Medium", color: "bg-brand-gold", width: "66%" };
		...
		<AuthLayout>
			...
			>
				...
				<form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
					...
					<motion.div variants={itemVariants} className='space-y-1.5'>
						...
						<div className='relative group'>
							<UserIcon className='absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground group-focus-within:text-brand-orange transition-colors' />
							<Input
								id='signup-name'
					...
					<motion.div variants={itemVariants} className='space-y-1.5'>
						...
						<div className='relative group'>
							<Mail className='absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground group-focus-within:text-brand-orange transition-colors' />
							<Input
								id='signup-email'
								type='email'
					...
					<motion.div variants={itemVariants} className='space-y-1.5'>
						...
						<div className='relative group'>
							<Lock className='absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground group-focus-within:text-brand-orange transition-colors' />
							<Input
								id='signup-password'
							...
							<motion.button
								...
								className='absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-brand-orange transition-colors'
								whileTap={{ scale: 0.8 }}
							>
								{showPassword ? (
						...
						<AnimatePresence>
							{password && (
								...
								>
									<div className='mt-4 p-4 rounded-2xl bg-muted/40 border border-border/50 space-y-3'>
				...
				>
					...
					<Link
						to='/terms'
						className='text-foreground font-bold hover:text-brand-orange transition-colors'
					>
						Terms
					</Link>{" "}
					and{" "}
