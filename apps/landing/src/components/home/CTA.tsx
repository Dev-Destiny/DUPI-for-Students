...
const CTA: FC = () => {
	return (
		<section className='py-24 bg-brand-violet text-white overflow-hidden relative'>
					...
					>
						<div className='relative group inline-block'>
							...
							<Link to='/waitlist' className='block w-full'>
								<button className='relative w-full overflow-hidden bg-brand-orange text-white hover:bg-brand-orange-dark transition-all duration-300 cursor-pointer flex items-center justify-center gap-2 px-10 h-16 text-xl font-bold rounded-full shadow-lg'>
					...
					<div className='mt-16 grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 max-w-2xl mx-auto'>
						...
						>
							<div className='relative'>
								<span className='text-3xl md:text-4xl font-black mb-1 block tracking-tighter'>
									1.2M+
								</span>
								<motion.div
			...
			{/* Background Blur */}
			<div className='absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-brand-orange/20 blur-[100px] rounded-full' />
		</section>
	);
};
