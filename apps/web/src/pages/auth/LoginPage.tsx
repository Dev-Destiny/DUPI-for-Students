    ...
    <AuthLayout>
      ...
      >
          ...
          <motion.div variants={itemVariants} className="space-y-1.5">
            <div className="flex items-center justify-between px-1">
              ...
              {errors.password ? (
                ...
                <Link to="/forgot-password" className="text-xs text-brand-orange hover:text-primary transition-colors font-bold">
                  Reset?
                </Link>
              )}
            </div>
        ...
        <motion.p variants={itemVariants} className="mt-8 text-center text-sm text-slate-500">
          New to DUPI?{" "}
          <Link to="/signup" className="text-brand-orange hover:text-primary font-bold transition-colors">
            Create an account
          </Link>
        </motion.p>
      </motion.div>
